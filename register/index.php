            ...
            <div class="container">
                <div class="row">
                    <div class="board">
                      ...
                      <li class="active"><a href="#profile" data-toggle="tab" title="profile">
                         <span class="round-tabs two">
                             <i class="glyphicon glyphicon-user"></i>
                         </span>
               </a>
                     </li>
                     <li><a href="#skills" data-toggle="tab" title="bootsnipp goodies">
                         <span class="round-tabs three">
                              <i class="glyphicon glyphicon-briefcase"></i>
                         </span> </a>
                         </li>

                         <li><a href="#prefrence" data-toggle="tab" title="blah blah">
              ...
              <div class="col-sm-4 form-group">
                <input type="text" placeholder="Level" class="form-control">
					...
					<button type="button" class="btn btn-lg btn-info">Submit</button>
                          ...
                          <div class="tab-pane fade" id="prefrences">
